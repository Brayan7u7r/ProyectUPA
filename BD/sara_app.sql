...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-09-2021 a las 22:45:19
...
--
-- Volcado de datos para la tabla `d_tbl_municipio`
--
...
--
-- Volcado de datos para la tabla `d_tbl_razonsocial`
--
...
--
-- Volcado de datos para la tabla `d_tbl_rol`
--
...
--
-- Volcado de datos para la tabla `tbl_aspirante`
--
...
--
-- Volcado de datos para la tabla `tbl_postulacion`
--
...
CREATE TABLE `tbl_vacante` (
  ...
  `Vac_disponibilidad` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `Vac_experiencia` varchar(500) COLLATE utf8_spanish_ci NOT NULL,
  `Vac_estudios` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `tbl_vacante` (`Oid`, `Vac_fechafin`, `Vac_cargo`, `Vac_img_referencia`, `Vac_lugar_vacante`, `Vac_disponibilidad`, `Vac_experiencia`, `Vac_estudios`, `Fk_tblUsuario`) VALUES
(1, '2021-09-30', 'Analista Sistemas', 'img.png', 'Apartadó', 'Inmediata', '2 años de experiencia', 'Tecnología en sistemas', 1),
(2, '2021-09-30', 'Panadero', 'jpeg.panadero', 'Chigorodó', 'Inmediata', '1 Año de experiencia', 'Bachiller Academico', 1),
(3, '2021-09-30', 'Polinizador', 'gif.gif', 'Chigorodó', 'Normal', 'Conocimiento React JS', 'Bachiller Academico', 1),
(4, '2021-09-30', 'Barcadillero', 'barca.png', 'Apartadó', 'Normal', 'Senior JavaScript + 2 años', 'Ingeniero en sistemas', 1);
